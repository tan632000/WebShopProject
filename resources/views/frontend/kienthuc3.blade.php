...
<div class="wrap">
    <div class="container">
        <div class="box-2">
            <div class="title1">
                <h1><a href="">Đâu là chiếc điện thoại được mong đợi nhất sẽ ra mắt nửa cuối năm 2021</a></h1>
            </div>
            <div class="kienthuc1">
                <h2>Đâu là chiếc điện thoại được mong đợi nhất sẽ ra mắt nửa cuối năm 2021?</h2>
                <div>
                    <img src="{{ asset('images/1.png') }}" alt=""><br />
                ...
                <div>
                    <img src="{{ asset('images/xiaomi11.jpg') }}" alt="">
                </div>
                ...
                <div>
                    <img src="{{ asset('images/ip13.jpg') }}" alt="">
                </div>
