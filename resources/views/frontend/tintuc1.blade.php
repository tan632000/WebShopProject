...
<div class="wrap">
    <div class="container">
        <div class="box-2">
            <div class="title1">
                <h1><a href="">Messi, Neymar hay nhất Copa America 2021</a></h1>
            </div>
            <div class="kienthuc1">
                ...
                <div>
                    <img src="{{ asset('images/neymar-messi.jpg') }}" alt=""> <br>
                ...
                <div>
                    <img src="{{ asset('images/neymar-messi1.jpg') }}" alt=""> <br>
                ...
                <div>
                    <img src="{{ asset('images/neymar-messi2.jpg') }}" alt=""><br >
