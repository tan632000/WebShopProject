...
<div class="wrap">
    <div class="container">
        <div class="box-2">
            <div class="title1">
                <h1><a href="">Rò rỉ hình ảnh ốp lưng của iPhone 13 Pro </a></h1>
            </div>
            <div class="kienthuc1">
                ...
                <div>
                    <img src="{{ asset('images/cauhinhse3.jpg') }}" alt=""><br />
                </div>
                ...
                <div>
                    <img src="{{ asset('images/cauhinhse3t.jpg') }}" alt=""><br />
                </div> <br>
                ...
                <h6><a href="">Đâu là chiếc điện thoại được mong đợi nhất sẽ ra mắt nửa cuối năm 2021</a></h6>
            </div>
