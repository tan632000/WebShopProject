...
<form action="{{route('category_add')}}" method="POST">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" name="name" class="form-control form-control-lg" id="inputEmail3" placeholder="Enter Category Name">
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        <textarea id="summary-ckeditor"  name="description"  class="form-control" rows="3"></textarea>
