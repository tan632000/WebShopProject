...
class FrontendController extends Controller
{
    function index(){
        ...
        return view('frontend/home',['smartProducts'=>$smartProducts,'livingProducts'=>$livingProducts])->with(compact('smartProducts','livingProducts'));
    }
    function product_details_by_id($product_id)
    {
        ...
        return view('frontend/product_details',['product'=>$product,'relatedProducts'=>$relatedProducts,'slider_images'=>$slider_images]);
    }
